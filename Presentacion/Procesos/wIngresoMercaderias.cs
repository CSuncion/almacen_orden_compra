...
{
    public partial class wIngresoMercaderias : Heredados.MiForm8
    {
        public wIngresoMercaderias()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Productos Terminados";
        ...
        List<ControlEditar> ListaCtrls()
        {
            ...
            xCtrl.txtNoFoco(this.txtCorEnc, this.dtpFecMovCab, "ffff");
            xLis.Add(xCtrl);
        ...
        public void InicializaVentana(EncajadoEN pObj)
        {           
        ...
        {
            this.txtCorEnc.Text = pObj.CorrelativoEncajado;
            this.txtCodAlm.Text = "A13";
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(EncajadoEN pObj)
        {
            //asignar parametros
            MovimientoCabeEN iMovCabEN = new MovimientoCabeEN();
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoProductoTerminado;
        ...
        public void ActualizareOperacion(EncajadoEN pObj)
        {
            ...
            {
                if (pObj.CEstadoEncajado == "0")//pendiente
                {
        ...
        public void VentanaAdicionar(EncajadoEN pObj)
        {
            ...
            ProduccionProTerRN.ModificarCostosFaseEmpaquetadoProTer(pObj);
            ProduccionProTerRN.ModificarCostosManoObraProTer(pObj);
            ProduccionProTerRN.ModificarCostosIngresoIndirectoProTer(pObj);
        ...
        public void VentanaModificar(EncajadoEN pObj)
        {
            this.InicializaVentana(pObj);
            ...
            this.LLenarMovimientoDetaAlAdicionar(pObj);           
            this.MostrarMovimientoDeta();
            //this.LLenarLoteDeBaseDatos(pObj);
            eMas.AccionHabilitarControles(1);          
            eMas.AccionPasarTextoPrincipal();        
            this.dtpFecMovCab.Focus();
        }

        public void VentanaVisualizar(EncajadoEN pObj)
        {
            this.InicializaVentana(pObj);
            this.MostrarMovimientoCabe(this.ObtenerMovimientoCabeIngresoBD(pObj));
        ...
        public void LLenarMovimientoDetaDeBaseDatos(EncajadoEN pObj)
        {
            MovimientoDetaEN iMovDetEN = new MovimientoDetaEN();
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoProductoTerminado;
        ...
        public void LLenarMovimientoDetaAlAdicionar(EncajadoEN pObj)
        {
            //asignar parametros
            EncajadoEN iEncEN = pObj;
            MovimientoCabeEN iMovCabEN = this.NuevoMovimientoCabeDeVentana();

            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoMercaderia(iEncEN, iMovCabEN);
        }

        public void LLenarProduccionProTerDeBaseDatos(EncajadoEN pObj)
        {
            ProduccionProTerEN iProProTerEN = new ProduccionProTerEN();
            iProProTerEN.ClaveEncajado = pObj.ClaveEncajado;
            iProProTerEN.Adicionales.CampoOrden = ProduccionProTerEN.CorProProTer;
            this.eLisProProTer = ProduccionProTerRN.ListarProduccionProTerParaIngresoProductoTerminado(iProProTerEN);
        }
        ...
        public void Adicionar()
        {
            ...
            //modificar los productos terminados
            ...
            this.wEnc.eClaveDgvProCab = Dgv.ObtenerValorCelda(this.wEnc.DgvProCab, ProduccionDetaEN.ClaObj);
            this.wEnc.ActualizarVentana();

            //imprimir la nota
            //this.wEnc.AccionImprimirIngresoProductoTerminado();
        ...
        public void ModificarEncajado()
        {
            ...
            iEncEN.ClaveEncajado = Dgv.ObtenerValorCelda(this.wEnc.DgvProCab, ProduccionDetaEN.ClaObj);
            iEncEN.ClaveIngresoProductoTerminado = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            EncajadoRN.ModificarPorIngresoProductosTerminados(iEncEN);            
        }
        ...
        public void AdicionarLotes()
        {
            ...
            {
                //obtener el ultimo codigo lote de bd para este ProTer
                string iNuevoCodigoLote = LoteRN.ObtenerMaximoValorEnColumna(xProProTer.CodigoAlmacen, xProProTer.CodigoExistencia);

                //obtener la lista de liberaciones ProTer para generar los los lotes
                List<LiberacionProTer> iLisLibProTer = ProduccionProTerRN.ListarLiberacionesProTerParaGenerarLotesAProductoTerminado(xProProTer);

                //recorrer cada objeto
                foreach (LiberacionProTer xLibProTer in iLisLibProTer)
                {
                    //crear nuevo objeto lote
                    LoteEN iLotEN = new LoteEN();

                    //actualizar con la claveMovimientoCabe
                    iLotEN.CodigoEmpresa = Universal.gCodigoEmpresa;
                    iLotEN.CodigoAlmacen = xProProTer.CodigoAlmacen;
                    iLotEN.CodigoExistencia = xProProTer.CodigoExistencia;
                    iLotEN.DescripcionExistencia = xProProTer.DescripcionExistencia;
                    iLotEN.CodigoLote = Numero.IncrementarCorrelativoNumerico(ref iNuevoCodigoLote, 6);
                    iLotEN.FechaProduccionLote = xLibProTer.FechaLote;
                    iLotEN.FechaVencimientoLote = xLibProTer.FechaVcto;
                    iLotEN.StockLote = xLibProTer.Cantidad;
                    iLotEN.StockSaldoLote = xLibProTer.Cantidad;
                    iLotEN.ClaveLote = LoteRN.ObtenerClaveLote(iLotEN);
                    iLotEN.ClaveMovimientoCabe = iClaveMovimientoCabe;
        ...
        public bool EsPersonalValido()
        {
            ...
            {
                Mensaje.OperacionDenegada(iPerEN.Adicionales.Mensaje, this.wEnc.eTitulo);
        ...
        private void wIngresoMercaderias_FormClosing(object sender, FormClosingEventArgs e)
        {
