...
{
    public partial class wDetalleIngresoDevolucion : Heredados.MiForm8
    {
        public wDetalleIngresoDevolucion()
        {
            InitializeComponent( );
        }
        ...
        public wEditIngresoDevolucion wEditIngDev;
        ...
        public void ListarExistencias()
        {
            ...
            win.eExiEN.CodigoAlmacen = this.wEditIngDev.txtCodAlm.Text.Trim();
            win.eLisMovDet = this.wEditIngDev.eLisMovDet;
            //win.eClaveFormulaCabe = ProduccionDetaRN.ObtenerClaveFormulaCabe(Dgv.ObtenerValorCelda(this.wEditIngDev.wIngDev.wParTra.DgvProDet,
        ...
        public bool EsCodigoExistenciaValido()
        {
            ...
            //string iClaveFormulaCabe = ProduccionDetaRN.ObtenerClaveFormulaCabe(Dgv.ObtenerValorCelda(this.wEditIngDev.wIngDev.wParTra.DgvProDet,
                //ProduccionDetaEN.ClaObj));
