...
{
    public partial class wSalidaUnidadesEmpacarRE : Heredados.MiForm8
    {
        public wSalidaUnidadesEmpacarRE()
        {
            InitializeComponent();
        }
        ...
        public void ValoresXDefecto(RetiquetadoEN pObj)
        {
            ...
            this.txtCodAlm.Text = pObj.CodigoAlmacenPT;
        ...
        public void LLenarMovimientosDetaDeBaseDatos(RetiquetadoEN pObj)
        {
        ...
        public void LLenarMovimientoDetaAlAdicionar(RetiquetadoEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaSalidaEmpaquetarRE(iRetEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            this.ActualizarCostoUnidadEncajado();
        ...
        public void ModificarRetiquetado()
        {
            ...
            iRetEN.ClaveRetiquetado = Dgv.ObtenerValorCelda(this.wRet.DgvRet, RetiquetadoEN.ClaObj);
            iRetEN.ClaveSalidaUnidadesEmpacar = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            RetiquetadoRN.ModificarPorSalidaUnidadesAEmpaquetar(iRetEN);            
        }

        public void ActualizarCostoUnidadEncajado()
        {
            //asignar parametros
            RetiquetadoEN iRet = this.wRet.EsRetiquetadoExistente();

            //ejecutar metodo
            RetiquetadoRN.ModificarCostoUnidadEncajado(iRet);
        }
        ...
        private void wSalidaUnidadesEmpacarRE_FormClosing(object sender, FormClosingEventArgs e)
        {
