...
{
    public partial class wDetalleMotivoPrimeraLiberacion : Heredados.MiForm8
    {
        public wDetalleMotivoPrimeraLiberacion()
        {
            InitializeComponent( );
        }
        ...
        public wMotivoPrimeraLiberacion wMotPriLib;
        ...
        {
            pObj.TipoMotivoLiberacion = this.wMotPriLib.eTipoMotivo;           
        ...
        public void Adicionar( )
        {
            ...
            this.wMotPriLib.eClaveDgvMotLib = this.wMotPriLib.eLisMotLib[this.wMotPriLib.eLisMotLib.Count - 1].ClaveObjeto;
            this.wMotPriLib.ActualizarDgvMot( );
            this.wMotPriLib.MostrarCantidadTotal();
        ...
        {         
            ...
            //adicionar detalle
            this.wMotPriLib.eLisMotLib.Add(iMotLibEN); 
        }

        public void ActualizarCampoDetalleMotivo()
        {
            //asignar parametro
            string iCampoDetalleMotivo = LiberacionRN.ConvertirListaACampoDetalleMotivo(this.wMotPriLib.eLisMotLib);

            //ejecutar metodo(segun tipoMotivo)
            switch (this.wMotPriLib.eTipoMotivo)
            {
                case "MotRep": this.wMotPriLib.wPriLib.eLibMotEN.DetalleMotivoReproceso = iCampoDetalleMotivo; break;
                case "MotMue": this.wMotPriLib.wPriLib.eLibMotEN.DetalleMotivoMuestra = iCampoDetalleMotivo; break;
                case "MotDes": this.wMotPriLib.wPriLib.eLibMotEN.DetalleMotivoDesecho = iCampoDetalleMotivo; break;
            }
        }
        ...
        public void Modificar( )
        {
            ...
            //Actualizar propietario
            this.wMotPriLib.eClaveDgvMotLib = this.wMotPriLib.eLisMotLib[Dgv.ObtenerIndiceRegistroXFranja(this.wMotPriLib.DgvBot)].ClaveObjeto;
            this.wMotPriLib.ActualizarDgvMot( );
            this.wMotPriLib.MostrarCantidadTotal();
        ...
        public void ModificarMotivoLiberacion()
        {
            ...
            MotivoLiberacion iProProTerEN = this.wMotPriLib.eLisMotLib[Dgv.ObtenerIndiceRegistroXFranja(this.wMotPriLib.DgvBot)];
            this.AsignarMotivoLiberacion(iProProTerEN);
            
            //modificar el objeto en la lista
            ListaG.Modificar<MotivoLiberacion>(this.wMotPriLib.eLisMotLib, iProProTerEN, MotivoLiberacion.CodMotLib, iProProTerEN.CodigoMotivoLiberacion);            
        }
        ...
        {
            this.wMotPriLib.eLisMotLib.RemoveAt( Dgv.ObtenerIndiceRegistroXFranja( this.wMotPriLib.DgvBot ) );
        }
        ...
        public ItemGEN NuevoItemGVentana()
        {
            ...
            iIteGEN.CodigoTabla = this.wMotPriLib.eTipoMotivo;
        ...
        public bool EsMotivoValido()
        {
            ...
            string iCodigoItemGFranjaGrilla = Dgv.ObtenerValorCelda(this.wMotPriLib.DgvBot, MotivoLiberacion.CodMotLib);
            List<MotivoLiberacion> iLisMotLibGrilla = this.wMotPriLib.eLisMotLib;
        ...
        public void ListarMotivos()
        {
            ...
            win.eIteEN.CodigoTabla = this.wMotPriLib.eTipoMotivo;
            win.eLisMotLib = this.wMotPriLib.eLisMotLib;
        ...
        {
            //asignar parametros
            decimal iCantidadTipoMotivo = this.wMotPriLib.eCantidadMotivo;
            List<MotivoLiberacion> iLisMotLib = this.wMotPriLib.eLisMotLib;
