...
{
    public partial class wIngresoDesecho : Heredados.MiForm8
    {
        public wIngresoDesecho()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Unidades Desechas";
        ...
        public void ActualizareOperacion(LiberacionEN pObj)
        {
            if (pObj.ClaveIngresoTransferenciaDesechas == string.Empty)
            {
                this.eOperacion = Universal.Opera.Adicionar;
            }
            else
        ...
        public void LLenarMovimientoDetaDeBaseDatos(LiberacionEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoTransferenciaDesechas;
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoUnidadesDesechas(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego el ingreso de unidades para desechos correctamente", this.eTitulo);
        ...
        public void ModificarLiberacion()
        {
            ...
            iLibEN.ClaveIngresoTransferenciaDesechas = this.ObtenerClaveMovimientoCabe();
            
            //ejecutar metodo
            LiberacionRN.ModificarPorTransferenciaDesechos(iLibEN);
        }
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico el ingreso de unidades para desecho correctamente", this.wLib.eTitulo);
        ...
        private void wIngresoDesecho_FormClosing(object sender, FormClosingEventArgs e)
        {
