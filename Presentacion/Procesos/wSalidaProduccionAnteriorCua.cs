...
{
    public partial class wSalidaProduccionAnteriorCua : Heredados.MiForm8
    {
        public wSalidaProduccionAnteriorCua()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Salida Unidades Para Empaquetar";
        ...
        public void ValoresXDefecto(EncajadoEN pObj)
        {
            ...
            this.txtCodAlm.Text = "A23";//almacen cuarentena
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeSalidaBD(EncajadoEN pObj)
        {
            //asignar parametros
            MovimientoCabeEN iMovCabEN = new MovimientoCabeEN();
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveSalidaUnidadesEmpacarCuarentena;
        ...
        {
            if (pObj.ClaveSalidaUnidadesEmpacarCuarentena == string.Empty)
            {
        ...
        public void VentanaVisualizar(EncajadoEN pObj)
        {
            this.InicializaVentana(pObj);
            this.MostrarMovimientoCabe(this.ObtenerMovimientoCabeSalidaBD(pObj));
            this.LLenarMovimientosDetaDeBaseDatos(pObj);
            this.MostrarMovimientoDeta();
        ...
        public void LLenarMovimientosDetaDeBaseDatos(EncajadoEN pObj)
        {
            MovimientoDetaEN iMovDetEN = new MovimientoDetaEN();
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveSalidaUnidadesEmpacarCuarentena;
        ...
        public void LLenarMovimientoDetaAlAdicionar(EncajadoEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaSalidaEmpaquetarCuarentena(iEncEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            //actualizar el costo insumos semi producto
            this.ActualizarCostoInsumosAProTer();
            ...
            //imprimir la nota
            //this.wEnc.AccionImprimirSalidasEmpaquetar();
        ...
        public void ModificarEncajado()
        {
            ...
            iEncEN.ClaveSalidaUnidadesEmpacarCuarentena = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            EncajadoRN.ModificarPorSalidaUnidadesAEmpaquetarCuarentena(iEncEN);            
        }

        public void ActualizarCostoInsumosAProTer()
        {
            //asignar parametros
            EncajadoEN iEnc = this.wEnc.EsEncajadoExistente();
            List<MovimientoDetaEN> iLisMovDet = this.eLisMovDet;

            //ejecutar metodo
            ProduccionProTerRN.ModificarCostoInsumoSemiProducto(iEnc, iLisMovDet);
        }
        
        public void DescontarProduccionesDeta()
        {
            LiberacionRN.DescontarUnidadesPorEmpaquetado(this.eLisMovDet);
        }
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            Mensaje.OperacionSatisfactoria("Se modifico la salida correctamente", this.wEnc.eTitulo);
        ...
        private void wSalidaProduccionAnteriorCua_FormClosing(object sender, FormClosingEventArgs e)
        {
