...
{
    public partial class wIngresoReprocesoQali : Heredados.MiForm8
    {
        public wIngresoReprocesoQali()
        {
            InitializeComponent();
        }
        ...
        public void ValoresXDefecto(ProduccionDetaEN pObj)
        {
            ...
            this.txtCodAlm.Text = "A18";//ALMACEN DE REPROCESO
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(ProduccionDetaEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoReprocesoQali;
        ...
        public void LLenarMovimientoDetaDeBaseDatos(ProduccionDetaEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoReprocesoQali;
        ...
        public void LLenarMovimientoDetaAlAdicionar(ProduccionDetaEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoReprocesoQali(iProDetEN, iMovCabEN);
        }
        ...
        public void ModificarProduccionDeta()
        {
            ...
            iProDetEN.ClaveIngresoReprocesoQali = this.ObtenerClaveMovimientoCabe();
