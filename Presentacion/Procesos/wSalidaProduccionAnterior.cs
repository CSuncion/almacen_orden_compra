...
{
    public partial class wSalidaProduccionAnterior : Heredados.MiForm8
    {
        public wSalidaProduccionAnterior()
        {
            InitializeComponent();
        }
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeSalidaBD(EncajadoEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveSalidaUnidadesEmpacar;
        ...
        public void LLenarMovimientosDetaDeBaseDatos(EncajadoEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveSalidaUnidadesEmpacar;
        ...
        public void LLenarMovimientoDetaAlAdicionar(EncajadoEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaSalidaEmpaquetar(iEncEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            //validar si la grilla esta vacia
        ...
        public void ModificarEncajado()
        {
            ...
            iEncEN.ClaveSalidaUnidadesEmpacar = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            EncajadoRN.ModificarPorSalidaUnidadesAEmpaquetar(iEncEN);            
        }
        ...
        private void wSalidaFaseControlCalidad_FormClosing(object sender, FormClosingEventArgs e)
        {
