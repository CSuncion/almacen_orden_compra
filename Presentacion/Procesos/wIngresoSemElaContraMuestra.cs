...
{
    public partial class wIngresoSemElaContraMuestra : Heredados.MiForm8
    {
        public wIngresoSemElaContraMuestra()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Unidades Contra Muestra";
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(ProduccionDetaEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoSemElaContraMuestra;
        ...
        public void LLenarMovimientoDetaAlAdicionar(ProduccionDetaEN pObj)
        {
            ...
            //ejecutar metodo            
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoSemElaContraMuestra(iProDetEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            ////imprimir la nota            
            //this.wParTra.AccionImprimirIngresoSemiElaboradoContraMuestra();
        ...
        public void ModificarProduccionDeta()
        {
            ...
            iProDetEN.ClaveIngresoSemElaContraMuestra = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo            
            ProduccionDetaRN.ModificarPorIngresoSemElaContraMuestra(iProDetEN);
        }
