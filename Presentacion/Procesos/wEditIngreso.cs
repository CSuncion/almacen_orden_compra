...
namespace Presentacion.Procesos
{
    public partial class wEditIngreso : Heredados.MiForm8
    {
        ...
        {
            //titulo ventana
            this.Text = this.eOperacion.ToString() + Cadena.Espacios(1) + this.wIng.eTitulo;
        ...
        public void AsignarMovimientoCabe(MovimientoCabeEN pMovCab)
        {
            ...
            pMovCab.PeriodoMovimientoCabe = wIng.lblPeriodo.Text;
        ...
        public void Adicionar()
        {
            ...
            if(this.wIng.EsActoAdicionarMovimientoCabe().Adicionales.EsVerdad== false) { return; }
                     
            //desea realizar la operacion?
            if (Mensaje.DeseasRealizarOperacion(this.wIng.eTitulo) == false) { return; }
            ...
            Mensaje.OperacionSatisfactoria("Se agrego el ingreso correctamente", this.wIng.eTitulo);
        ...
        public void Modificar()
        {
            ...
            if (this.wIng.EsMovimientoCabeExistente().Adicionales.EsVerdad == false) { return; }
            ...
            //mensaje satisfactorio
            Mensaje.OperacionSatisfactoria("Se modifico el ingreso correctamente", this.wIng.eTitulo);
        ...
        public void Eliminar()
        {
            ...
            //mensaje satisfactorio
            Mensaje.OperacionSatisfactoria("Se elimino el ingreso correctamente", this.wIng.eTitulo);
        ...
        public bool EsTipoOperacionValido()
        {
            ...
            {
                Mensaje.OperacionDenegada(iTipOpeEN.Adicionales.Mensaje, this.wIng.eTitulo);
        ...
        public bool EsAlmacenValido()
        {
            ...
            {
                Mensaje.OperacionDenegada(iAlmEN.Adicionales.Mensaje, this.wIng.eTitulo);
        ...
        public bool EsPersonalValido()
        {
            ...
            {
                Mensaje.OperacionDenegada(iPerEN.Adicionales.Mensaje, this.wIng.eTitulo);
        ...
        public bool EsProveedorValido()
        {
            ...
            {
                Mensaje.OperacionDenegada(iAuxEN.Adicionales.Mensaje, this.wIng.eTitulo);
        ...
        public bool ValidaFechaMovimientoCabe()
        {
            ...
            {
                Mensaje.OperacionDenegada(iMovCabEN.Adicionales.Mensaje, this.wIng.eTitulo);
                this.dtpFecMovCab.Focus();
            }
        ...
        {
            //asignar parametros
            string iPeriodoRegistro = this.wIng.lblPeriodo.Text;
        ...
        {
            Generico.CancelarVentanaEditar(this, eOperacion, eMas, this.wIng.eTitulo);
        }
