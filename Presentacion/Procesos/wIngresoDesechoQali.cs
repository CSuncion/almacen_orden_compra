...
{
    public partial class wIngresoDesechoQali : Heredados.MiForm8
    {
        public wIngresoDesechoQali()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Unidades Desechos";
        ...
        public void ValoresXDefecto(ProduccionDetaEN pObj)
        {
            ...
            this.txtCodAlm.Text = "A14";//ALMACEN DE DESECHO
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(ProduccionDetaEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoDesechoQali;
        ...
        public void LLenarMovimientoDetaDeBaseDatos(ProduccionDetaEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoDesechoQali;
        ...
        public void LLenarMovimientoDetaAlAdicionar(ProduccionDetaEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoDesechoQali(iProDetEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            ////imprimir la nota
            //this.wParTra.AccionImprimirIngresoDesechoQali();
        ...
        public void ModificarProduccionDeta()
        {
            ...
            iProDetEN.ClaveIngresoDesechoQali = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            ProduccionDetaRN.ModificarPorIngresoDesechoQali(iProDetEN);
        }
        ...
        private void wIngresoDesechoQali_FormClosing(object sender, FormClosingEventArgs e)
        {
