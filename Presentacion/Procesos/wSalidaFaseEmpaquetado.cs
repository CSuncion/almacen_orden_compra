...
{
    public partial class wSalidaFaseEmpaquetado : Heredados.MiForm8
    {
        public wSalidaFaseEmpaquetado()
        {
            InitializeComponent();
        }
        ...
        public void LLenarProduccionExisDeBaseDatos()
        {
            ...
            iProExiEN.ClaveEncajado = Dgv.ObtenerValorCelda(this.wEnc.DgvProCab, ProduccionExisEN.ClaObj);    
            this.eLisProExi = ProduccionExisRN.ListarProduccionExisAcumuladoXClaveEncajado(iProExiEN);
        }
        ...
        public void ModificarEncajado()
        {
            ...
            //ejecutar metodo
            EncajadoRN.ModificarPorSalidaInsumosFaseEmpaquetado(iEncEN);
        }

        public void ModificarProducionExis()
        {
            //asignar parametros
            List<ProduccionExisEN> iLisProExi = ProduccionExisRN.ListarProduccionExisXClaveEncajado(Dgv.ObtenerValorCelda(this.wEnc.DgvProCab,
        ...
        public bool HayStockExistenciasParaParteTrabajo()
        {
            ...
            {
                //instanciar
                wInsumosFaltantesEncajado win = new wInsumosFaltantesEncajado();
                win.eVentanaPropietario = this;
                win.eLisInsFal = iLisInsFal;                       
                TabCtrl.InsertarVentana(this, win);
                win.NuevaVentana(this.wEnc.EsEncajadoExistente());
        ...
        private void wSalidaFaseEmpaquetado_FormClosing(object sender, FormClosingEventArgs e)
        {
