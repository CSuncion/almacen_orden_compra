...
{
    public partial class wInsumosFaltantesCompra : Heredados.MiForm8
    {
        public wInsumosFaltantesCompra()
        {
            InitializeComponent();
        }
        ...
        public void ExportarExcel()
        {
            ...
            try
            {
                ...
                foreach (InsumoFaltante xInsFal in this.eLisInsFal)
                {
                    ...
                    iHoja.Cells.Item[iIndiceFila, 2] = xInsFal.CodigoAlmacen;
                    iHoja.Cells.Item[iIndiceFila, 3] = xInsFal.CodigoExistencia;
                    iHoja.Cells.Item[iIndiceFila, 4] = xInsFal.DescripcionExistencia;
                    iHoja.Cells.Item[iIndiceFila, 5] = xInsFal.NUnidadMedida;
                    iHoja.Cells.Item[iIndiceFila, 6] = xInsFal.CantidadParteTrabajo;
                    iHoja.Cells.Item[iIndiceFila, 7] = xInsFal.CantidadStockExistencia;
                    iHoja.Cells.Item[iIndiceFila, 8] = xInsFal.CantidadFaltante;
