...
{
    public partial class wTransferenciaReprocesoAnaBloq : Heredados.MiForm8
    {
        public wTransferenciaReprocesoAnaBloq()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Transferencia Unidades Reproceso";
        ...
        public void MostrarDatosPersonalDeAlmacenIngreso()
        {
            //asignar parametro
            AlmacenEN iAlmEN = new AlmacenEN();
            iAlmEN.CodigoAlmacen = "A18";//almacen de reprocesos
            iAlmEN.ClaveAlmacen = AlmacenRN.ObtenerClaveAlmacen(iAlmEN);
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeSalidaBD(LiberacionEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveSalidaTransferenciaReproceso;
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(LiberacionEN pObj)
        {
            //asignar parametros
            MovimientoCabeEN iMovCabEN = new MovimientoCabeEN();
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoTransferenciaReproceso;
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaSalidaTransferenciaUnidadesReproceso(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego la transferencia de unidades para reprocesos correctamente", this.eTitulo);
        ...
        {            
            ...
            iLibEN.ClaveIngresoTransferenciaReproceso = this.ObtenerClaveMovimientoCabeIngreso();
            iLibEN.ClaveSalidaTransferenciaReproceso = this.ObtenerClaveMovimientoCabeSalida();

            //ejecutar metodo
            LiberacionRN.ModificarPorTransferenciaReproceso(iLibEN);
        }
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico la transferencia de unidades para reprocesos correctamente", this.wAnaBlo.eTitulo);
        ...
        private void wTransferenciaReprocesoAnaBloq_FormClosing(object sender, FormClosingEventArgs e)
        {
