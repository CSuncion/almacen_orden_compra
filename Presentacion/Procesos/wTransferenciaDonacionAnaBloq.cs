...
{
    public partial class wTransferenciaDonacionAnaBloq : Heredados.MiForm8
    {
        public wTransferenciaDonacionAnaBloq()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Salida Unidades Donadas";
        ...
        public void MostrarDatosPersonalDeAlmacenIngreso()
        {
            //asignar parametro
            AlmacenEN iAlmEN = new AlmacenEN();
            iAlmEN.CodigoAlmacen = "A19";//almacen de donaciones
            iAlmEN.ClaveAlmacen = AlmacenRN.ObtenerClaveAlmacen(iAlmEN);
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeSalidaBD(LiberacionEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveSalidaTransferenciaDonacion;
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(LiberacionEN pObj)
        {
            //asignar parametros
            MovimientoCabeEN iMovCabEN = new MovimientoCabeEN();
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoTransferenciaDonacion;
        ...
        {
            if (pObj.ClaveSalidaTransferenciaDonacion == string.Empty)
            {
        ...
        public void LLenarMovimientoDetaDeBaseDatos(LiberacionEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveSalidaTransferenciaDonacion;
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaSalidaTransferenciaUnidadesDonacion(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego la transferencia de unidades para Donacion correctamente", this.eTitulo);
        ...
        public void ModificarLiberacion()
        {
            ...
            iLibEN.ClaveIngresoTransferenciaDonacion = this.ObtenerClaveMovimientoCabeIngreso();
            iLibEN.ClaveSalidaTransferenciaDonacion = this.ObtenerClaveMovimientoCabeSalida();

            //ejecutar metodo
            LiberacionRN.ModificarPorTransferenciaDonacion(iLibEN);
        }
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico la transferencia de unidades para donacion correctamente", this.wAnaBlo.eTitulo);
