...
{
    public partial class wInsumosFaltantesRetiquetado : Heredados.MiForm8
    {
        public wInsumosFaltantesRetiquetado()
        {
            InitializeComponent();
        }
        ...
        {
            this.txtCorProDet.Text = pObj.CorrelativoRetiquetado;         
        }
        ...
        public void ExportarExcel()
        {
            ...
            try
            {
                ...
                iHoja.Cells.Item[1, 1] = "Retiquetado :  " + this.txtCorProDet.Text.Trim();
        ...
        private void wInsumosFaltantesRetiquetado_FormClosing(object sender, FormClosingEventArgs e)
        {
