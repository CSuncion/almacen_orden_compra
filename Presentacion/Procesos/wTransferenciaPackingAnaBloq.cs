...
{
    public partial class wTransferenciaPackingAnaBloq : Heredados.MiForm8
    {
        public wTransferenciaPackingAnaBloq()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Transferencia Unidades Packing";
        ...
        public void MostrarDatosPersonalDeAlmacenIngreso()
        {
            //asignar parametro
            AlmacenEN iAlmEN = new AlmacenEN();
            iAlmEN.CodigoAlmacen = "A11";//almacen de productos en proceso
            iAlmEN.ClaveAlmacen = AlmacenRN.ObtenerClaveAlmacen(iAlmEN);
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeSalidaBD(LiberacionEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveSalidaTransferenciaPacking;
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(LiberacionEN pObj)
        {
            //asignar parametros
            MovimientoCabeEN iMovCabEN = new MovimientoCabeEN();
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoTransferenciaPacking;
        ...
        {
            if (pObj.ClaveSalidaTransferenciaPacking == string.Empty)
            {
        ...
        public void LLenarMovimientoDetaDeBaseDatos(LiberacionEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveSalidaTransferenciaReproceso;
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaSalidaTransferenciaUnidadesPacking(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego la transferencia de unidades para packing correctamente", this.eTitulo);
        ...
        {            
            ...
            iLibEN.ClaveIngresoTransferenciaPacking = this.ObtenerClaveMovimientoCabeIngreso();
            iLibEN.ClaveSalidaTransferenciaPacking = this.ObtenerClaveMovimientoCabeSalida();

            //ejecutar metodo
            LiberacionRN.ModificarPorTransferenciaPacking(iLibEN);
        }
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico la transferencia de unidades para packing correctamente", this.wAnaBlo.eTitulo);
        ...
        private void wTransferenciaPackingAnaBloq_FormClosing(object sender, FormClosingEventArgs e)
        {
