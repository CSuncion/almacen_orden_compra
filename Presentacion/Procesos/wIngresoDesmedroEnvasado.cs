...
{
    public partial class wIngresoDesmedroEnvasado : Heredados.MiForm8
    {
        public wIngresoDesmedroEnvasado()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso insumos";
        ...
        public void ValoresXDefecto(ProduccionDetaEN pObj)
        {
            ...
            this.txtCodAlm.Text ="A21";//almacen desmedro              
        }
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(ProduccionDetaEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoDesmedroEnvasado;
        ...
        public void ActualizareOperacion(ProduccionDetaEN pObj)
        {
            ...
            {
                if (pObj.NumeroUnidadesMasa == 0 || pObj.CEstadoProduccionDeta == "0")
                {
        ...
        public void MostrarProduccionExis()
        {
            ...
            //List<ProduccionExisEN> iFuenteDatos = ListaG.Filtrar<ProduccionExisEN>(this.eLisProExi, ProduccionExisEN.CEstDes, "1");
            List<ProduccionExisEN> iFuenteDatos = ListaG.Refrescar<ProduccionExisEN>(this.eLisProExi);
        ...
        public List<DataGridViewColumn> ListarColumnasDgvCom()
        {
            ...
            iLisRes.Add(Dgv.NuevaColumnaTextNumerico(ProduccionExisEN.CanDes, "Cant", 100, 5));
        ...
        {
            //asignar parametros            
            //string iClaveProduccionDeta = Dgv.ObtenerValorCelda(this.wParTra.DgvProDet, ProduccionDetaEN.ClaObj);

            //ejecutar metodo            
            //this.eLisProExi = ProduccionExisRN.ListarProduccionExisPorDesmedroEnvasado(iClaveProduccionDeta);
        }
        ...
        public void Adicionar()
        {
            ...
            if (this.ValidaCuandoItemsTienenCantidadDesmedroCero() == false) { return; }
        ...
        {
            //asignar parametros
            List<ProduccionExisEN> iLisProExi = ListaG.Filtrar<ProduccionExisEN>(this.eLisProExi, ProduccionExisEN.CEstDes, "1");
            MovimientoCabeEN iMovCabEN = this.NuevoMovimientoCabeDeVentana();

            //ejecutar metodo
            MovimientoDetaRN.AdicionarMovimientoDetaPorIngresoInsumos(iLisProExi, iMovCabEN);
        }
        ...
        public void ModificarProduccionDeta()
        {
            ...
            iProDetEN.ClaveIngresoDesmedroEnvasado = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            ProduccionDetaRN.ModificarPorIngresoInsumosDesmedroEnvasado(iProDetEN);
        }
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico el ingreso correctamente", this.wParTra.eTitulo);
        ...
        public void AccionModificarItem()
        {
            ...
            //Valida Monto Menor o igual a cero
            if (this.ValidaCantidadMenorOIgualACero() == false) { return; }

            wDetalleDesmedroEnvasado win = new wDetalleDesmedroEnvasado();
            win.wIngDesEnv = this;
        ...
        public bool ValidaCantidadMenorOIgualACero()
        {
            int iIndiceFila = Dgv.ObtenerIndiceRegistroXFranja(this.dgvProExi);
            ProduccionExisEN iProExiEN = this.eLisProExi[iIndiceFila];
            if (iProExiEN.CEstadoDesmedro == "0")
            {
                Mensaje.OperacionDenegada("No se puede agregar motivos", "Detalle");
                return false;
            }
            return true;
        }
        ...
        //    List<ProduccionExisEN> iLisProExi = ListaG.Filtrar<ProduccionExisEN>(this.eLisProExi, ProduccionExisEN.CEstDes, "0");
        ...
        //    //regenerar
        //    ListaG.Modificar<ProduccionExisEN>(this.eLisProExi, ProduccionExisEN.CEstDes, "0", ProduccionExisEN.CEstDes, "1");
        ...
        public void AccionRegenerarItems()
        {
            ...
            //regenerar
            ProduccionExisRN.ModificarPorRegenerarDesmedro(this.eLisProExi);
        ...
        public bool ValidaCuandoItemsTienenCantidadDesmedroCero()
        {
            //asignar parametros
            List<ProduccionExisEN> iLisProExi = ListaG.Filtrar<ProduccionExisEN>(this.eLisProExi, ProduccionExisEN.CEstDes, "1");//solo activos

            //ejecutar metodo
            ProduccionExisEN iProExiEN = ProduccionExisRN.ValidaCuandoItemsTienenCantidadDesmedroCero(iLisProExi);
        ...
        private void wIngresoDesmedroEnvasado_FormClosing(object sender, FormClosingEventArgs e)
        {
