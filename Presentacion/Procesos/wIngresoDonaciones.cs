...
{
    public partial class wIngresoDonaciones : Heredados.MiForm8
    {
        public wIngresoDonaciones()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Unidades Donadas";
        ...
        public void ActualizareOperacion(LiberacionEN pObj)
        {
            if (pObj.ClaveIngresoTransferenciaDonacion == string.Empty)
            {
                this.eOperacion = Universal.Opera.Adicionar;
            }
            else
        ...
        public void LLenarMovimientoDetaDeBaseDatos(LiberacionEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoTransferenciaDonacion;
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoUnidadesDonacion(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego el ingreso de unidades para donacion correctamente", this.eTitulo);
        ...
        public void ModificarLiberacion()
        {
            ...
            iLibEN.ClaveIngresoTransferenciaDonacion = this.ObtenerClaveMovimientoCabe();
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico el ingreso de unidades para donacion correctamente", this.wLib.eTitulo);
        ...
        private void wIngresoDonaciones_FormClosing(object sender, FormClosingEventArgs e)
        {
