...
{
    public partial class wEditIngresoDevolucion : Heredados.MiForm8
    {
        public wEditIngresoDevolucion()
        {
            InitializeComponent();
        }
        ...
        {
            //titulo ventana
            this.Text = this.eOperacion.ToString() + Cadena.Espacios(1) + this.wIngDev.eTitulo;
        ...
        {
            this.InicializaVentana();
            //this.ValoresXDefecto(this.wIngDev.wParTra.EsProduccionDetaExistente());
        ...
        public void AsignarMovimientoCabe(MovimientoCabeEN pMovCab)
        {
            ...
            //pMovCab.ClaveProduccionDeta= Dgv.ObtenerValorCelda(this.wIngDev.wParTra.DgvProDet, ProduccionDetaEN.ClaObj);
        ...
        public void Adicionar()
        {
            ...
            if (Mensaje.DeseasRealizarOperacion(this.wIngDev.eTitulo) == false) { return; }
            ...
            Mensaje.OperacionSatisfactoria("Se agrego la ingreso correctamente", this.wIngDev.eTitulo);

            //actualizar al propietario           
            this.wIngDev.eClaveDgvMovCab = this.ObtenerClaveMovimientoCabe();
            this.wIngDev.ActualizarVentana();

            //imprimir la nota
            this.wIngDev.AccionImprimirNota();
        ...
        public void AdicionarMovimientosDeta()
        {
            ...
            foreach (MovimientoDetaEN xMovDet in this.eLisMovDet)
            {
                ...
                //xMovDet.ClaveProduccionDeta = Dgv.ObtenerValorCelda(this.wIngDev.wParTra.DgvProDet, ProduccionDetaEN.ClaObj);
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            Mensaje.OperacionSatisfactoria("Se modifico la salida correctamente", this.wIngDev.eTitulo);
        ...
        {
            //preguntar si este objeto fue eliminado mientras estaba activa la ventana
            if (this.wIngDev.EsMovimientoCabeExistente().Adicionales.EsVerdad == false) { return; }
            ...
            //mensaje satisfactorio
            Mensaje.OperacionSatisfactoria("Se elimino el ingreso correctamente", this.wIngDev.eTitulo);
        ...
        public void ListarAlmacenes()
        {
            ...
            //win.eProDetEN = this.wIngDev.wParTra.EsProduccionDetaExistente();
        ...
        public bool EsAlmacenValido()
        {
            ...
            iAlmEN.ClaveAlmacen = AlmacenRN.ObtenerClaveAlmacen(iAlmEN);
            //ProduccionDetaEN iProDetEN = this.wIngDev.wParTra.EsProduccionDetaExistente();
        ...
        public bool EsPersonalValido()
        {
            ...
            {
                Mensaje.OperacionDenegada(iPerEN.Adicionales.Mensaje, this.wIngDev.eTitulo);
        ...
        public void AccionAgregarItem()
        {
            ...
            //instanciar
            wDetalleIngresoDevolucion win = new wDetalleIngresoDevolucion();
        ...
        public bool ValidaFechaMovimientoCabeAlAdicionar()
        {
            ...
            {
                Mensaje.OperacionDenegada(iMovCabEN.Adicionales.Mensaje, this.wIngDev.eTitulo);
                this.dtpFecMovCab.Focus();
            }
        ...
        public bool ValidaFechaMovimientoCabeAlModificar()
        {
            ...
            //asignar parametros
            MovimientoCabeEN iMovCabEN = this.wIngDev.EsMovimientoCabeExistente();
        ...
        {
            Generico.CancelarVentanaEditar(this, eOperacion, eMas, this.wIngDev.eTitulo);
        }
