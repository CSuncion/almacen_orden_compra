...
{
    public partial class wIngresoMuestraQali : Heredados.MiForm8
    {
        public wIngresoMuestraQali()
        {
            InitializeComponent();
        }
        ...
        public void ValoresXDefecto(ProduccionDetaEN pObj)
        {
            ...
            this.txtCodAlm.Text = "A20";//ALMACEN DE CONTRA MUESTRA
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(ProduccionDetaEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoMuestraQali;
        ...
        public void LLenarMovimientoDetaDeBaseDatos(ProduccionDetaEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoMuestraQali;
        ...
        public void LLenarMovimientoDetaAlAdicionar(ProduccionDetaEN pObj)
        {
            ...
            //ejecutar metodo            
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoMuestraQali(iProDetEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            ////imprimir la nota            
            //this.wParTra.AccionImprimirIngresoMuestraQali();
        ...
        public void ModificarProduccionDeta()
        {
            ...
            iProDetEN.ClaveIngresoMuestraQali = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            //ProduccionDetaRN.ModificarPorIngresoReprocesoQali(iProDetEN);
            ProduccionDetaRN.ModificarPorIngresoMuestraQali(iProDetEN);
        }
        ...
        public void Modificar()
        {
            ...
            ////imprimir la nota
            //this.wParTra.AccionImprimirIngresoReprocesoQali();
        ...
        private void wIngresoReprocesoQali_FormClosing(object sender, FormClosingEventArgs e)
        {
