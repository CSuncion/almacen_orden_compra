...
{
    public partial class wIngresoMuestras : Heredados.MiForm8
    {
        public wIngresoMuestras()
        {
            InitializeComponent();
        }
        ...
        public void ActualizareOperacion(LiberacionEN pObj)
        {
            if (pObj.ClaveIngresoTransferenciaMuestra == string.Empty)
            {
                this.eOperacion = Universal.Opera.Adicionar;
            }
            else
        ...
        public void LLenarMovimientoDetaDeBaseDatos(LiberacionEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoTransferenciaMuestra;
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego el ingreso de unidades para muestra correctamente", this.eTitulo);
        ...
        public void ModificarLiberacion()
        {
            ...
            iLibEN.ClaveIngresoTransferenciaMuestra = this.ObtenerClaveMovimientoCabe();
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico el ingreso de unidades para muestra correctamente", this.wLib.eTitulo);
        ...
        private void wIngresoMuestras_FormClosing(object sender, FormClosingEventArgs e)
        {
