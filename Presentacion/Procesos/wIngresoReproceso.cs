...
{
    public partial class wIngresoReproceso : Heredados.MiForm8
    {
        public wIngresoReproceso()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Unidades Reproceso";
        ...
        public void ActualizareOperacion(LiberacionEN pObj)
        {
            if (pObj.ClaveIngresoTransferenciaReproceso == string.Empty)
            {
                this.eOperacion = Universal.Opera.Adicionar;
            }
            else
        ...
        public void LLenarMovimientoDetaDeBaseDatos(LiberacionEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoTransferenciaReproceso;
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoUnidadesReproceso(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego el ingreso de unidades para reproceso correctamente", this.eTitulo);
        ...
        public void ModificarLiberacion()
        {
            ...
            iLibEN.ClaveIngresoTransferenciaReproceso = this.ObtenerClaveMovimientoCabe();
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico el ingreso de unidades para reproceso correctamente", this.wLib.eTitulo);
        ...
        private void wIngresoReproceso_FormClosing(object sender, FormClosingEventArgs e)
        {
