...
namespace Presentacion.Procesos
{
    public partial class wEditLote : Heredados.MiForm8
    {
        ...
        public void AsignarLote(LoteEN pObj)
        {
            ...
            pObj.CodigoAlmacen = this.wLot.wDetIng.wEditIng.txtCodAlm.Text.Trim();
            pObj.CodigoExistencia = this.wLot.wDetIng.txtCodExi.Text.Trim();
            pObj.DescripcionExistencia = this.wLot.wDetIng.txtDesExi.Text.Trim();
        ...
        public void Adicionar( )
        {
            ...
            this.wLot.wDetIng.CambiarAtributoSoloLecturaACodigoExistencia();
            this.wLot.wDetIng.MostrarCosto();
        ...
        public void MostrarNuevoCodigoLote()
        {
            ...
            List<LoteEN> iLisLot = this.wLot.wDetIng.eLisLotExi;
        ...
        public void AdicionarLote()
        {
            ...
            //adicionar detalle
            LoteRN.AdicionarLote(this.wLot.wDetIng.eLisLotExi, iLotEN); 
        }
        ...
        public void ModificarLote()
        {
            ...
            //ejecutar metodo
            LoteRN.ModificarLote(this.wLot.wDetIng.eLisLotExi, iLotEN);
        }
        ...
        public void EliminarLote()
        {
            ...
            //ejecutar metodo
            LoteRN.EliminarLote(this.wLot.wDetIng.eLisLotExi, iLotEN);
        }
        ...
        {
            this.wLot.wDetIng.txtCantMovDet.Text = Formato.NumeroDecimal(Dgv.SumarColumna(this.wLot.dgvLot, LoteEN.StoLot), 3);
            this.wLot.wDetIng.txtCanCon.Text = Formato.NumeroDecimal(Dgv.SumarColumna(this.wLot.dgvLot, LoteEN.StoConLot), 3);
        }
        ...
        public void CambiarAtributoSoloLecturaACantidadConversion()
        {
            ...
            this.wLot.wDetIng.AsignarMovimientoDeta(iMovDetEN);
        ...
        public decimal ObtenerCantidad()
        {
            ...
            decimal iFactorConversion = Conversion.ADecimal(this.wLot.wDetIng.txtFacCon.Text, 0);
