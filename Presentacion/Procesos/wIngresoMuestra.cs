...
{
    public partial class wIngresoMuestra : Heredados.MiForm8
    {
        public wIngresoMuestra()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Salida Unidades Muestra";
        ...
        public void ValoresXDefecto(LiberacionEN pObj)
        {
            ...
            this.txtCodAlm.Text = pObj.CodigoAlmacenSemiProducto;            
        }

        public void MostrarDatosPersonalDeAlmacenSalida(string pCodigoAlmacen)
        {
            //asignar parametro
        ...
        public void MostrarDatosPersonalDeAlmacenIngreso()
        {
            //asignar parametro
            AlmacenEN iAlmEN = new AlmacenEN();
            iAlmEN.CodigoAlmacen = "A20";//almacen de CONTRAMUESTRAS
            iAlmEN.ClaveAlmacen = AlmacenRN.ObtenerClaveAlmacen(iAlmEN);
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeSalidaBD(LiberacionEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveSalidaTransferenciaMuestra;
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(LiberacionEN pObj)
        {
            //asignar parametros
            MovimientoCabeEN iMovCabEN = new MovimientoCabeEN();
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoTransferenciaMuestra;
        ...
        {
            if (pObj.ClaveSalidaTransferenciaMuestra == string.Empty)
            {
        ...
        public void VentanaAdicionar(LiberacionEN pObj)
        {
            ...
            this.MostrarDatosPersonalDeAlmacenSalida(pObj.CodigoAlmacenSemiProducto);
        ...
        public void LLenarMovimientoDetaDeBaseDatos(LiberacionEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveSalidaTransferenciaMuestra;
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoUnidadesMuestra(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego la transferencia de unidades para Muestra correctamente", this.eTitulo);
        ...
        public void ModificarLiberacion()
        {
            ...
            iLibEN.ClaveIngresoTransferenciaMuestra = this.ObtenerClaveMovimientoCabeIngreso();
            iLibEN.ClaveSalidaTransferenciaMuestra = this.ObtenerClaveMovimientoCabeSalida();

            //ejecutar metodo
            LiberacionRN.ModificarPorTransferenciaMuestra(iLibEN);
        }
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico la transferencia de unidades para donacion correctamente", this.wLib.eTitulo);
        ...
        private void wIngresoDonacion_FormClosing(object sender, FormClosingEventArgs e)
        {
