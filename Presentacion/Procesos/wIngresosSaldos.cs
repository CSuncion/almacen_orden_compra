...
{
    public partial class wIngresosSaldos : Heredados.MiForm8
    {
        public wIngresosSaldos()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Unidades Saldos";
        ...
        public void ValoresXDefecto(LiberacionEN pObj)
        {
            ...
            this.txtCodAlm.Text = LiberacionRN.ObtenerCodigoAlmacenParaUnidadesSaldo(pObj);
        }
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(LiberacionEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoSaldo;
        ...
        public void ActualizareOperacion(LiberacionEN pObj)
        {
            if (pObj.ClaveIngresoSaldo == string.Empty)
            {
                this.eOperacion = Universal.Opera.Adicionar;
            }
            else
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoUnidadesSaldo(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego el ingreso de unidades para saldos correctamente", this.eTitulo);
        ...
        public void ModificarLiberacion()
        {
            ...
            iLibEN.ClaveIngresoSaldo = this.ObtenerClaveMovimientoCabe();
            
            //ejecutar metodo
            LiberacionRN.ModificarPorTransferenciaSaldos(iLibEN);
        }
