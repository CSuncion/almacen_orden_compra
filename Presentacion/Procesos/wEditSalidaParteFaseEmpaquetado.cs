...
{
    public partial class wEditSalidaParteFaseEmpaquetado : Heredados.MiForm8
    {
        public wEditSalidaParteFaseEmpaquetado()
        {
            InitializeComponent();
        }
        ...
        {
            //titulo ventana
            this.Text = this.eOperacion.ToString() + Cadena.Espacios(1) + this.wSalParFasEmp.eTitulo;
            ...
            this.wSalParFasEmp.Enabled = false;
        ...
        {
            this.InicializaVentana();
            this.ValoresXDefecto(this.wSalParFasEmp.wProTerFasEmp.EsProduccionProTerExistente());
        ...
        public void AsignarMovimientoCabe(MovimientoCabeEN pMovCab)
        {
            ...
            pMovCab.ClaveEncajado = Dgv.ObtenerValorCelda(this.wSalParFasEmp.wProTerFasEmp.DgvProProTer, ProduccionProTerEN.ClaEnc); 
            pMovCab.ClaveProduccionProTerParteEmpaquetado = Dgv.ObtenerValorCelda(this.wSalParFasEmp.wProTerFasEmp.DgvProProTer, ProduccionProTerEN.ClaObj);    
        ...
        public void Adicionar()
        {
            ...
            //valida cuando fecha es menor a fecha encajado
            if (this.ValidaCuandoFechaEsMenorAFechaEncajado() == false) { return; }
            ...
            if (Mensaje.DeseasRealizarOperacion(this.wSalParFasEmp.eTitulo) == false) { return; }
            ...
            Mensaje.OperacionSatisfactoria("Se agrego la salida correctamente", this.wSalParFasEmp.eTitulo);

            //actualizar al propietario           
            this.wSalParFasEmp.eClaveDgvMovCab = this.ObtenerClaveMovimientoCabe();
            this.wSalParFasEmp.ActualizarVentana();

            //imprimir la nota
            this.wSalParFasEmp.AccionImprimirNota();
        ...
        public void AdicionarMovimientosDeta()
        {
            ...
            foreach (MovimientoDetaEN xMovDet in this.eLisMovDet)
            {
                ...
                xMovDet.ClaveEncajado = Dgv.ObtenerValorCelda(this.wSalParFasEmp.wProTerFasEmp.DgvProProTer, ProduccionProTerEN.ClaEnc);
                xMovDet.ClaveProduccionProTerParteEmpaquetado = Dgv.ObtenerValorCelda(this.wSalParFasEmp.wProTerFasEmp.DgvProProTer, ProduccionProTerEN.ClaObj);
            }
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            Mensaje.OperacionSatisfactoria("Se modifico la salida correctamente", this.wSalParFasEmp.eTitulo);
        ...
        {
            //preguntar si este objeto fue eliminado mientras estaba activa la ventana
            if (this.wSalParFasEmp.EsMovimientoCabeExistente().Adicionales.EsVerdad == false) { return; }
            ...
            //mensaje satisfactorio
            Mensaje.OperacionSatisfactoria("Se elimino el ingreso correctamente", this.wSalParFasEmp.eTitulo);
        ...
        public bool EsPersonalValido()
        {
            ...
            {
                Mensaje.OperacionDenegada(iPerEN.Adicionales.Mensaje, this.wSalParFasEmp.eTitulo);
        ...
        public void AccionAgregarItem()
        {
            ...
            //instanciar
            wAgregarParteFaseEmpaquetado win = new wAgregarParteFaseEmpaquetado();
            win.wEdiSalParFasEmp = this;
        ...
        public void AccionQuitarItem()
        {
            ...
            //eliminar
            this.eLisMovDet.RemoveAt(Dgv.ObtenerIndiceRegistroXFranja(this.dgvMovDet));

            //mensaje satisfactorio
            Mensaje.OperacionSatisfactoria("Se elimino el item", "Item");

            //mostrar movimientos deta
            this.MostrarMovimientosDeta();
        ...
        public bool ValidaFechaMovimientoCabeAlAdicionar()
        {
            ...
            {
                Mensaje.OperacionDenegada(iMovCabEN.Adicionales.Mensaje, this.wSalParFasEmp.eTitulo);
                this.dtpFecMovCab.Focus();
            }
        ...
        public bool ValidaFechaMovimientoCabeAlModificar()
        {
            ...
            //asignar parametros
            MovimientoCabeEN iMovCabEN = this.wSalParFasEmp.EsMovimientoCabeExistente();
        ...
        public bool ValidaCuandoFechaEsMenorAFechaEncajado()
        {
            //validar solo cuando adiciona y modifica
            if (MiForm.VerdaderoCuandoAdicionaYModifica((int)this.eOperacion) == false) { return true; }
            ...
            //asignar parametros
            MovimientoCabeEN iMovCabEN = this.NuevoMovimientoCabeDeVentana();
            string iFechaEncajado = Dgv.ObtenerValorCelda(this.wSalParFasEmp.wProTerFasEmp.DgvProProTer, ProduccionProTerEN.FecEnc);

            //validar
            iMovCabEN = MovimientoCabeRN.ValidaCuandoFechaEsMenorAFechaEncajado(iMovCabEN, iFechaEncajado);
            if (iMovCabEN.Adicionales.EsVerdad == false)
            {
                Mensaje.OperacionDenegada(iMovCabEN.Adicionales.Mensaje, this.wSalParFasEmp.eTitulo);
                this.dtpFecMovCab.Focus();
        ...
        {
            Generico.CancelarVentanaEditar(this, eOperacion, eMas, this.wSalParFasEmp.eTitulo);
        }
        ...
        private void wEditSalidaParteFaseEmpaquetado_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.wSalParFasEmp.Enabled = true;
        }
