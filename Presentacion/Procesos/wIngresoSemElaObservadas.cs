...
{
    public partial class wIngresoSemElaObservadas : Heredados.MiForm8
    {
        public wIngresoSemElaObservadas()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso de unidades observadas de proceso";
        ...
        public void ValoresXDefecto(ProduccionDetaEN pObj)
        {
            ...
            this.txtCodAlm.Text = "A25";//ALMACEN DE BLOQUEADOS
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(ProduccionDetaEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoSemElaBloqueadas;
        ...
        public void LLenarMovimientoDetaDeBaseDatos(ProduccionDetaEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoSemElaBloqueadas;
        ...
        public void LLenarMovimientoDetaAlAdicionar(ProduccionDetaEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoSemElaObservadas(iProDetEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            ////imprimir la nota
            //this.wParTra.AccionImprimirIngresoSemiElaboradoObservados();
        ...
        public void ModificarProduccionDeta()
        {
            ...
            iProDetEN.ClaveIngresoSemElaBloqueadas = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            ProduccionDetaRN.ModificarPorIngresoSemElaObservadas(iProDetEN);
        }
        ...
        public void Modificar()
        {
            ...
            //actualizar al wLot          
           //primirIngresoSemiElaboradoObservados();
        ...
        private void wIngresoSemElaObservadas_FormClosing(object sender, FormClosingEventArgs e)
        {
