...
{
    public partial class wSalidaProduccionAnteriorObs : Heredados.MiForm8
    {
        public wSalidaProduccionAnteriorObs()
        {
            InitializeComponent();
        }
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeSalidaBD(EncajadoEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveSalidaUnidadesEmpacarObservados;
        ...
        {
            if (pObj.ClaveSalidaUnidadesEmpacarObservados == string.Empty)
            {
        ...
        public void LLenarMovimientosDetaDeBaseDatos(EncajadoEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveSalidaUnidadesEmpacarObservados;
        ...
        public void LLenarMovimientoDetaAlAdicionar(EncajadoEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaSalidaEmpaquetarObservados(iEncEN, iMovCabEN);
        }
        ...
        public void ModificarEncajado()
        {
            ...
            iEncEN.ClaveSalidaUnidadesEmpacarObservados = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            EncajadoRN.ModificarPorSalidaUnidadesAEmpaquetarObservados(iEncEN);            
        }
        ...
        private void wSalidaProduccionAnteriorObs_FormClosing(object sender, FormClosingEventArgs e)
        {
