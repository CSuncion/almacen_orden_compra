...
{
    public partial class wIngresoCuarentenaQali : Heredados.MiForm8
    {
        public wIngresoCuarentenaQali()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Unidades Cuarentena";
        ...
        public void ValoresXDefecto(ProduccionDetaEN pObj)
        {
            ...
            this.txtCodAlm.Text = "A23";//ALMACEN DE CUARENTENA
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(ProduccionDetaEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoCuarentenaQali;
        ...
        public void LLenarMovimientoDetaDeBaseDatos(ProduccionDetaEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoCuarentenaQali;
        ...
        public void LLenarMovimientoDetaAlAdicionar(ProduccionDetaEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoCuarentenaQali(iProDetEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            ////imprimir la nota
            //this.wParTra.AccionImprimirIngresoCuarentenaQali();
        ...
        public void ModificarProduccionDeta()
        {
            ...
            iProDetEN.ClaveIngresoCuarentenaQali = this.ObtenerClaveMovimientoCabe();

            //ejecutar metodo
            ProduccionDetaRN.ModificarPorIngresoCuarentenaQali(iProDetEN);
        }
        ...
        private void wIngresoCuarentenaQali_FormClosing(object sender, FormClosingEventArgs e)
        {
