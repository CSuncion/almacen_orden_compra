...
{
    public partial class wDetalleIngresoDevolucionEncajado : Heredados.MiForm8
    {
        public wDetalleIngresoDevolucionEncajado()
        {
            InitializeComponent( );
        }
        ...
        public wEditIngresoDevolucionEncajado wEditIngDev;
        ...
        List<ControlEditar> ListaCtrls( )
        {
            ...
            xCtrl = new ControlEditar();
            xCtrl.TxtNumeroConDecimales(this.txtPreUniMovDet, true, "Precio Unitario", "vvff", 5, 12);
            xLis.Add(xCtrl);
        ...
        public void InicializaVentana( )
        {
            ...
            this.wEditIngDev.Enabled = false;
        ...
        public void AsignarMovimientoDeta(MovimientoDetaEN pObj)
        {
            ...
            pObj.FechaMovimientoCabe = this.wEditIngDev.dtpFecMovCab.Text;
            pObj.PeriodoMovimientoCabe = Fecha.ObtenerPeriodo(pObj.FechaMovimientoCabe, "-");
            pObj.CodigoAlmacen = this.wEditIngDev.txtCodAlm.Text.Trim();
            pObj.CodigoTipoOperacion = this.wEditIngDev.txtCodTipOpe.Text.Trim();
            pObj.CCalculaPrecioPromedio = this.wEditIngDev.txtCCalPrePro.Text.Trim();
            pObj.CClaseTipoOperacion = "1";//ingreso
            pObj.NumeroMovimientoCabe = this.wEditIngDev.txtNumMovCab.Text.Trim();           
            ...
            pObj.ClaveMovimientoCabe = this.wEditIngDev.ObtenerClaveMovimientoCabe();
        }
        ...
        public void Adicionar( )
        {
            ...
            this.wEditIngDev.eClaveDgvMovDet = this.wEditIngDev.eLisMovDet[this.wEditIngDev.eLisMovDet.Count - 1].ClaveObjeto;
            this.wEditIngDev.MostrarMovimientosDeta( );
            this.wEditIngDev.CambiarSoloLecturaACodigoAlmacen();
        ...
        {         
            ...
            //adicionar detalle
            MovimientoDetaRN.AdicionarMovimientoDeta(this.wEditIngDev.eLisMovDet, iComDetEN); 
        }
        ...
        public void Modificar( )
        {
            ...
            //Actualizar propietario
            this.wEditIngDev.eClaveDgvMovDet = this.wEditIngDev.eLisMovDet[Dgv.ObtenerIndiceRegistroXFranja(this.wEditIngDev.dgvMovDet)].ClaveObjeto;
            this.wEditIngDev.MostrarMovimientosDeta( );
        ...
        {           
            this.AsignarMovimientoDeta( this.wEditIngDev.eLisMovDet[Dgv.ObtenerIndiceRegistroXFranja( this.wEditIngDev.dgvMovDet )] );
        }
        ...
        {
            this.wEditIngDev.eLisMovDet.RemoveAt( Dgv.ObtenerIndiceRegistroXFranja( this.wEditIngDev.dgvMovDet ) );
        }
        ...
        public void ListarExistencias()
        {
            ...
            win.eLisMovDet = this.wEditIngDev.eLisMovDet;
            win.eClaveProduccionProTer = Dgv.ObtenerValorCelda(this.wEditIngDev.wIngDevEnc.wCanAdiEnc.DgvProProTer, ProduccionProTerEN.ClaObj);
            win.eCondicionLista = wLisExi.Condicion.ListarExistenciasFaseEncajadoParaProduccionNoSeleccionadasEnGrilla;
            TabCtrl.InsertarVentana(this, win);
            win.NuevaVentana();
        }
        ...
        public bool EsCodigoExistenciaValido()
        {
            ...
            string iCodigoExistenciaFranjaGrilla = Dgv.ObtenerValorCelda(this.wEditIngDev.dgvMovDet, MovimientoDetaEN.CodExi);
            List<MovimientoDetaEN> iLisMovDetGrilla = this.wEditIngDev.eLisMovDet;
            Universal.Opera iOperacionVentana = this.eOperacion;
            string iClaveProduccionProTer = Dgv.ObtenerValorCelda(this.wEditIngDev.wIngDevEnc.wCanAdiEnc.DgvProProTer, ProduccionProTerEN.ClaObj);

            //ejecutar metodo
            iExiEN = ExistenciaRN.EsExistenciaActivoParaEncajadoValido(iExiEN, iOperacionVentana, iCodigoExistenciaFranjaGrilla,
                iClaveProduccionProTer, iLisMovDetGrilla);
        ...
        public MovimientoDetaEN ObtenerMovimientoDetaFranjaGrilla()
        {
            ...
            if (this.wEditIngDev.eLisMovDet.Count != 0)
            {
                iMovDetEN = this.wEditIngDev.eLisMovDet[Dgv.ObtenerIndiceRegistroXFranja(this.wEditIngDev.dgvMovDet)];
            }
        ...
        public decimal ObtenerPrecioUnitario(ExistenciaEN pObj)
        {
            ...
            string iCCalculaPrecioPromedio = this.wEditIngDev.txtCCalPrePro.Text.Trim();
            string iCodigoExistenciaAModificar = Dgv.ObtenerValorCelda(this.wEditIngDev.dgvMovDet, MovimientoDetaEN.CodExi);
        ...
        public ExistenciaEN NuevaExistenciaVentana()
        {
            ...
            iExiEN.CodigoAlmacen = this.wEditIngDev.txtCodAlm.Text.Trim();
            iExiEN.DescripcionAlmacen = this.wEditIngDev.txtDesAlm.Text.Trim();
        ...
        private void wDetalleIngresoDevolucion_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.wEditIngDev.Enabled = true;
        }
