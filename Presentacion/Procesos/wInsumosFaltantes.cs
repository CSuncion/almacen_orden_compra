...
{
    public partial class wInsumosFaltantes : Heredados.MiForm8
    {
        public wInsumosFaltantes()
        {
            InitializeComponent();
        }
        ...
        List<ControlEditar> ListaCtrls()
        {
            ...
            xCtrl = new ControlEditar();
            xCtrl.txtNoFoco(this.txtCorProCab, this.btnExpExc, "ffff");
            xLis.Add(xCtrl);

            xCtrl = new ControlEditar();
            xCtrl.txtNoFoco(this.txtCodAlm, this.btnExpExc, "ffff");
            xLis.Add(xCtrl);

            xCtrl = new ControlEditar();
            xCtrl.txtNoFoco(this.txtDesAlm, this.btnExpExc, "ffff");
            xLis.Add(xCtrl);

            xCtrl = new ControlEditar();
            xCtrl.txtNoFoco(this.txtCodExi, this.btnExpExc, "ffff");
            xLis.Add(xCtrl);

            xCtrl = new ControlEditar();
            xCtrl.txtNoFoco(this.txtDesExi, this.btnExpExc, "ffff");
            xLis.Add(xCtrl);
        ...
        public void ExportarExcel()
        {
            ...
            try
            {
                ...
                iHoja.Cells.Item[1, 1] = "Correlativo :  " + this.txtCorProDet.Text.Trim();
                iHoja.Cells.Item[2, 1] = "Solicitud :  " + this.txtCorProCab.Text.Trim();
                iHoja.Cells.Item[3, 1] = "Almacen :  " + this.txtDesAlm.Text.Trim();
                iHoja.Cells.Item[4, 1] = "Formula :  " + this.txtDesExi.Text.Trim();
        ...
        private void wInsumosFaltantes_FormClosing(object sender, FormClosingEventArgs e)
        {
