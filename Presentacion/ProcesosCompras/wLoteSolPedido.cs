...
{
    public partial class wLoteSolPedido : Heredados.MiForm8
    {
        public wLoteSolPedido()
        {
            InitializeComponent();
        }
        ...
        {            
            ...
            this.wDetSolPedido.Enabled = false;
        ...
        {
            this.txtCodExi.Text = wDetSolPedido.txtCodExi.Text;
            this.txtDesExi.Text = wDetSolPedido.txtDesExi.Text;
        }
        ...
        public void MostrarLotes()
        {
            ...
            List<LoteEN> iFuenteDatos = ListaG.Refrescar<LoteEN>(this.wDetSolPedido.eLisLotExi);
        ...
        {           
            //instanciar
            wEditLoteSolPedido win = new wEditLoteSolPedido();
            win.wLot = this;
        ...
        public void AccionModificarItem()
        {
            ...
            this.eFranjaDgvLot = Dgv.Franja.PorValor;
            TabCtrl.InsertarVentana(this, win);
            win.VentanaModificar(LoteRN.BuscarLoteXClave(Dgv.ObtenerValorCelda(this.dgvLot,LoteEN.ClaObj),this.wDetSolPedido.eLisLotExi));
        }
        ...
        public void AccionQuitarItem()
        {
            ...
            TabCtrl.InsertarVentana(this, win);
            win.VentanaEliminar(LoteRN.BuscarLoteXClave(Dgv.ObtenerValorCelda(this.dgvLot, LoteEN.ClaObj), this.wDetSolPedido.eLisLotExi));
        }
        ...
        private void wLoteSolPedido_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.wDetSolPedido.Enabled = true;
        }
