...
{
    public partial class wLisUsu : Heredados.MiForm8
    {
        public wLisUsu()
        {
            InitializeComponent();
        ...
        public void ActualizarDgvLista()
        {
            ...
            switch (eCondicionLista)
            {
                ...
                case Condicion.UsuariosActivosExceptoUno: { iLis = UsuarioRN.ListarUsuariosActivosExceptoUno(eUsuEN); break; }
            }
            ...
            iDgv.AsignarColumnaTextCadena(UsuarioEN.NomUsu, "Descripcion", 210);
        }
